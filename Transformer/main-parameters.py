...
class Trainer(object):
    ...
    def train(self):
        ...
        for epoch in range(max_epoch):
            ...
            optimizer = optim.AdamW(self.model.parameters(), lr=config.learning_rate*np.cos(epoch*1.5/max_epoch), eps=1e-8)
            self.model.train()
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        print('-------------------'*10)
        ##############################################################
#         config.n_enc_seq = 256
#         config.n_dec_seq = 256
#         print(config)
#         trainer = Trainer(device='cuda')
#         trainer.train()
#         print('-------------------'*10)
        ##############################################################
        config.n_enc_seq = 1024
        config.n_dec_seq = 1024
        print(config)
        trainer = Trainer(device='cuda')
        trainer.train()
        config.n_enc_seq = 512
        config.n_dec_seq = 512
        print('-------------------'*10)
        ##############################################################
